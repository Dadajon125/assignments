    ...
    def __add__(self, other):
        if isinstance(other, OfficeSupply):
            if self.item_name == other.item_name:
                return OfficeSupply(self.item_name, self.box_count, self.price_per_box + other.box_count)
            return NotImplemented
        elif isinstance(other, int):
            return OfficeSupply(self.item_name, self.box_count, self.price_per_box + other)
        return NotImplemented
    def __eq__(self, other):
        if isinstance(other, OfficeSupply):
            return (self.item_name == other.item_name and
                    self.price_per_box == other.price_per_box)
        return NotImplemented
    def __bool__(self):
